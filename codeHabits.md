...
+ Coding
    > [Linux进程间通信-->Quick full-duplex pipes](http://beej.us/guide/bgipc/html/single/bgipc.html#audience)
...
+ Coding
  > [Linux signal & process](https://github.com/xmuli/linuxExample)
...
+ Coding
    > [Linux alarm](https://github.com/xmuli/linuxExample)
...
+ Coding
    > [Linux multiple thread control](https://xmuli.blog.csdn.net/article/details/105620043)
